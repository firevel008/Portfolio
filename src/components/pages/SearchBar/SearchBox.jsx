    ...
    return (
        <>
            <div className="bg-white border border-gray-200 rounded-lg shadow-sm dark:bg-gray-800 dark:border-gray-700 p-5">
                <h5 className="text-xl font-medium text-gray-900 dark:text-white">Search Fruits</h5>
                <p className='text-gray-500'>Search Fruits and get the nutritions values</p>
                <div className="mt-2">
                    <input
                        type="text"
                        value={query}
                    ...
                    {showDropdown && filteredItems.length > 0 && (
                        <ul className="absolute w-full border border-gray-300 bg-white mt-1 rounded shadow-lg">
                    ...
                    {selectedItem && (
                        <div className="mt-4 p-2 bg-gray-100 border border-gray-300 rounded">
                            ...
                            <p>Calories: ({selectedItem.nutritions.calories})</p>
                        </div>
                    )}
                </div>
            </div >
